package com.spym.navchenta_welcome.navigation
...
import com.spym.navchenta_welcome.LanguageSelectionActivity
import com.spym.navchenta_welcome.LanguageSelectionActivity2
import com.spym.navchenta_welcome.LanguageSelectionActivity3
import com.spym.navchenta_welcome.R
import com.spym.navchenta_welcome.databinding.ActivityMain2Binding
import com.spym.navchenta_welcome.feedback_send_status_api
import com.spym.navchenta_welcome.flag_credentials
import com.spym.navchenta_welcome.flag_receive
import com.spym.navchenta_welcome.navigation.ui.about_us
import com.spym.navchenta_welcome.navigation.ui.certificate.Certificate
import com.spym.navchenta_welcome.navigation.ui.help
...
class Drawer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val session_id = sharedPreferences_flag.getString("session_id", "")
//        showToast("session id is $session_id")
...
//        if(session_id.toString()=="-1"){
//
//            posttest.isEnabled = false
//            showToast("Before giving posttest you have to join session first")
//        }
//        else if(session_id.toString()!="-1"){
//            posttest.isEnabled = true
//        }
...
//        }
        ...
        posttest.setOnClickListener {
            if(session_id.toString()=="-1"){
                ...
                val preTime = sharedPreferences.getLong(KEY_PRETIME, 0)
                val diff = time - preTime
//                showToast("Remaining Time "+preTime.toString())
...
//                showToast(diffInSec.toString())
                if (diffInHr <= 48) {
                    val r_t = 48 - diffInHr
                    showToast("LOCKED: You have to wait for $r_t Hrs before taking the posttest")
